...
public class WorkflowClient {
    ...
    public void executeWorkflow(Class<?> workflowSpec, Object... args) {
        ...
        WorkflowStub workflowStub = workflowClient.newUntypedWorkflowStub(workflowType,
                new WorkflowOptions.Builder().setExecutionStartToCloseTimeout(Duration.ofSeconds(30)).setTaskList("test-task").build());
